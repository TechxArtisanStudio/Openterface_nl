...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'Bekijk product', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Bekijk product', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Bekijk product', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Accessoires', href: '/accessories/' },
